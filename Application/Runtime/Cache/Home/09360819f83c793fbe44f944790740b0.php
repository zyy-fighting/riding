...
<head>
  ...
  <title>Admin Template响应式后台模板 - 素材火www.sucaihuo.com</title>
    ...
    <div class="template-page-wrapper">
      <div class="navbar-collapse collapse templatemo-sidebar">
        <ul class="templatemo-sidebar-menu">
          ...
          <li class="active"><a href="http://www.sucaihuo.com/templates"><i class="fa fa-home"></i>Dashboard</a></li>
          <li class="sub open">
            <a href="javascript:;">
              <i class="fa fa-database"></i> Nested Menu <div class="pull-right"><span class="caret"></span></div>
            </a>
            <ul class="templatemo-submenu">
              <li><a href="http://www.sucaihuo.com/templates">Aenean</a></li>
              <li><a href="http://www.sucaihuo.com/templates">Pellentesque</a></li>
              <li><a href="http://www.sucaihuo.com/templates">Congue</a></li>             
              <li><a href="http://www.sucaihuo.com/templates">Interdum</a></li>
              <li><a href="http://www.sucaihuo.com/templates">Facilisi</a></li>
            </ul>
          </li>
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li><a href="http://www.sucaihuo.com/templates">Dashboard</a></li>
            <li class="active">Overview</li>
            <li><a href="sign-in.html">Sign In Form</a></li>
          </ol>
          <h1>Dashboard</h1>
          <p>Dashboard is <a rel="nofollow" href="index.html">free admin template</a> for everyone. Credits go to <a href="http://chartjs.org">Chart JS</a>, <a href="http://getbootstrap.com">Bootstrap</a>, and <a href="http://jqvmap.com">JQVMap</a>. templatemo provides <a href="http://www.sucaihuo.com/templates">free website templates</a> that can be used for any purpose. Morbi id nisi enim. Ut congue interdum pharetra facilisi. Aenean consectetur pellentesque mauris nec ornare. Nam tortor just, condimentum.</p>

          <div class="margin-bottom-30">
            <div class="row">
              <div class="col-md-12">
                <ul class="nav nav-pills">
                  <li class="active"><a href="http://www.sucaihuo.com/templates">Home <span class="badge">42</span></a></li>
                  <li class="active"><a href="http://www.sucaihuo.com/templates">Profile <span class="badge">126</span></a></li>
                  <li class="active"><a href="http://www.sucaihuo.com/templates">Messages <span class="badge">14</span></a></li>
                </ul>          
              </div>
            </div>
          </div>         
            ...
            <div class="col-md-6">
              <div class="templatemo-progress">
                <div class="list-group">
                  <a href="http://www.sucaihuo.com/templates" class="list-group-item active">
                  ...
                  <a href="http://www.sucaihuo.com/templates" class="list-group-item">
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="messages">
                    <div class="list-group">
                      ...
                      <a href="http://www.sucaihuo.com/templates" class="list-group-item">Dapibus ac facilisis in</a>
                      <a href="http://www.sucaihuo.com/templates" class="list-group-item">Morbi leo risus</a>
                      <a href="http://www.sucaihuo.com/templates" class="list-group-item">Porta ac consectetur ac</a>
                      <a href="http://www.sucaihuo.com/templates" class="list-group-item">Vestibulum at eros</a>
                    </div>
                  </div>
                  <div class="tab-pane fade" id="settings">
                    <div class="list-group">
                      <a href="http://www.sucaihuo.com/templates" class="list-group-item disabled">
                        Vivamus dictum posuere odio
                      </a>
                      <a href="http://www.sucaihuo.com/templates" class="list-group-item">Porta ac consectetur ac</a>
                      <a href="http://www.sucaihuo.com/templates" class="list-group-item">Vestibulum at eros</a>
      ...
      <footer class="templatemo-footer">
        <div class="templatemo-copyright">
          <p>Copyright &copy; 2084 Your Company Name Collect from <a href="http://www.sucaihuo.com/" title="网页模板" target="_blank">网页模板</a></p>
        </div>
      </footer>
    </div>
